...
class SuperAdminReportsController extends Controller {
    public function index() {
        ...
        $report = AttendanceReport::with('branch')->get();
        return view( 'super-admin.attendance.index', compact( 'report','reports' ) );
    }
    ...
    public function show( $id ) {
        ...
        return view( 'super-admin.attendance.show', compact( 'report' ) );
    }

    public function edit( $id ) {
        $report = AttendanceReport::findOrFail( $id );
        return view( 'super-admin.attendance.edit', compact( 'report' ) );
    }
