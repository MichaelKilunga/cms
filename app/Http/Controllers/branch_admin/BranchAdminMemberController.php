...
class BranchAdminMemberController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('branch_admin.members.index', compact('members'));
    }
    ...
    public function create()
    {
        ...
        $branches = Branch::all();
        $churches = Church::all();
        return view('branch_admin.members.create', compact('users', 'branches', 'churches'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('branch_admin.members')->with('success', 'Member added successfully.');
        } catch (\Exception $e) {
    ...
    {
        return view('branch_admin.members.show', compact('member'));
    }
    ...
    public function update(Request $request, Member $member)
    {
        ...
        try {
            ...
            return redirect()->route('branch_admin.members')->with('success', 'Member updated successfully.');
        } catch (\Exception $e) {
    ...
    public function destroy(Member $member)
    {
        ...
        return redirect()->route('branch_admin.members')->with('success', 'Member deleted successfully.');
        } catch (\Exception $e) {
    ...
    public function assignRole(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('branch_admin.members')->with('success', 'Role assigned successfully.');
        } catch (\Exception $e) {
            return redirect()->back()->withInput()->withErrors($validatedData)->with('error', $e->getMessage());
        }
    }
