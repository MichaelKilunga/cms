...
class BranchAdminFinanceController extends Controller
{
    ...
    public function show(Finance $finance)
    {
        ...
        return view('branch_admin.finances.show', compact('finance'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('branch_admin.finances')->with('success', 'Finance report created successfully.');
    ...
    public function update(Request $request, Finance $finance)
    {
        ...
        try {
            ...
            return redirect()->route('branch_admin.finances')->with('success', 'Finance report updated successfully.');
        } catch (\Illuminate\Validation\ValidationException $e) {
            // Log the errors for debugging
            \Illuminate\Support\Facades\Log::error('Validation failed', ['errors' => $e->errors()]);
            // Redirect back with error messages
    ...
    {
        $finance->delete();
        return redirect()->route('branch_admin.finances')->with('success', 'Finance report deleted successfully.');
    }
}
