...
class BranchPastorServiceController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('branch_pastor.services.index', compact('services', 'serviceCategories'));
    }

    public function show(Service $service)
    {
        return view('branch_pastor.services.show', compact('service'));
    }
    ...
    public function create()
    {
        ...
        return view('branch_pastor.services.create', compact('currentBranch', 'currentChurch', 'serviceCategories'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('branch_pastor.services')->with('success', 'Service report created successfully.');
    ...
    public function edit(Service $service)
    {
        ...
        return view('branch_pastor.services.edit', compact('service', 'branches', 'churches', 'serviceCategories'));
    }
    ...
    public function update(Request $request, Service $service)
    {
        try {
            ...
            return redirect()->route('branch_pastor.services')->with('success', 'Service report updated successfully.');
        } catch (\Illuminate\Validation\ValidationException $e) {
            // Log the errors for debugging
            \Illuminate\Support\Facades\Log::error('Validation failed', ['errors' => $e->errors()]);
            // Redirect back with error messages
    ...
    public function destroy(Service $service)
    {
        try{
        $service->delete();
        return redirect()->route('branch_pastor.services')->with('success', 'Service report deleted successfully.');
        } catch(\Exception $e){
            return redirect()->back()->with('error', $e->getMessage());
        }
    }

    public function approveServiceReport(Request $request, $id)
    {
        // dd($request->all());
        try {
            ...
            $service->update(['status' => $request['approve'], 'approval_reason' => $request['reason'], 'approval_by' => Auth::user()->id]);
