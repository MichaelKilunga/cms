...
class BranchPastorFinanceController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // dd($finances    );
        return view('branch_pastor.finances.index', compact('finances', 'services'));
    }
    ...
    public function show(Finance $finance)
    {
        ...
        return view('branch_pastor.finances.show', compact('finance'));
    }
    ...
    public function create()
    {
        ...
        return view('branch_pastor.finances.create', compact('services', 'currentChurch', 'currentBranch'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('branch_pastor.finances')->with('success', 'Finance report created successfully.');
    ...
    public function edit(Finance $finance)
    {
        ...
        return view('branch_pastor.finances.edit', compact('finance',  'services', 'currentChurch', 'currentBranch'));
    }
    ...
    public function update(Request $request, Finance $finance)
    {
        ...
        try {
            ...
            return redirect()->route('branch_pastor.finances')->with('success', 'Finance report updated successfully.');
        } catch (\Illuminate\Validation\ValidationException $e) {
            // Log the errors for debugging
            \Illuminate\Support\Facades\Log::error('Validation failed', ['errors' => $e->errors()]);
            // Redirect back with error messages
    ...
    {
        $finance->delete();
        return redirect()->route('branch_pastor.finances')->with('success', 'Finance report deleted successfully.');
    }
    ...
    public function approveFinanceReport(Request $request, $id)
    {
        ...
        try {
            ...
            $finance->update(['status' => $request['approve'], 'approval_reason' => $request['reason'], 'approval_by' => Auth::user()->id]);
