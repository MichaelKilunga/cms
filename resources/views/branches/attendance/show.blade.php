...
<div class="container mt-5 text-dark">
    <div class="card shadow-sm">
        <div class="card-header text-center bg-success text-white">
            <h2>Attendance Report for "<i>{{$report->service_name }}</i>" Service</h2>
        </div>
        ...
        <div class="card-footer text-center">
            <a href="{{ route('branch.reports', ['branch'=>$branch_id]) }}" class="btn btn-secondary">Back to List</a>
            <a href="{{ route('edit.reports',['branch'=>$branch_id,'report'=>$report['id']]) }}" class="btn btn-primary">Edit</a>
