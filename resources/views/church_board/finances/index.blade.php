...
<div class="container">
    ...
    <a href="{{ route('finances.create') }}" class="btn btn-primary mb-3">Add New Finance Report</a>
    <table class="table table-bordered">
        ...
        <tbody>
            @foreach ($finances as $finance)
                <tr>
                    <td>{{ $finance->service_category->name }}</td>
                    <td>{{ $finance->date }}</td>
                    ...
                    <td>
                        ...
                        <a href="{{ route('finances.show', $finance->id) }}" class="btn btn-success btn-sm">show</a>
