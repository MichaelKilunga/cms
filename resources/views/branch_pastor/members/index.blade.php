...
@section('content')
    <div class="container">
        <div class="mt-4 d-flex justify-content-between">
            ...
            <a href="{{ route('branch_pastor.members.create') }}" class="btn btn-primary mb-3">Add New Member</a>
        </div>
            ...
            <tbody>
                @foreach ($members as $member)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('branch_pastor.members.edit', $member->id) }}"
                                class="btn btn-warning btn-sm">Edit</a>
                            <a href="{{ route('branch_pastor.members.show', $member->id) }}"
                                class="btn btn-success btn-sm">show</a>
                            <form action="{{ route('branch_pastor.members.destroy', $member->id) }}" method="POST"
    ...
    <div class="modal fade" id="assignRoleModal" tabindex="-1" aria-labelledby="assignRoleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('branch_pastor.members.assign_role') }}" method="POST">
                    @csrf
