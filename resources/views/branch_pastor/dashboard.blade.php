        ...
        <div class="modal fade" id="memberModal" tabindex="-1" aria-labelledby="memberModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('branch_pastor.member.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="modal-body mb-3" hidden>
                            ...
                            <input type="number" name="church_id" value="{{ session('church_id') }}"
                                class="form-control">
                        </div>
                        <div class="modal-body mb-3">
                        ...
                        <div class="modal-body mb-3" hidden>
                            ...
                            <input type="number" name="branch_id" value="{{ session('branch_id') }}"
                                class="form-control">
                        </div>
        ...
        <div class="modal fade" id="serviceModal" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('branch_pastor.services.store') }}" method="POST">
                        @csrf
                        <div class="modal-body mb-3">
                        ...
                        <div class="modal-body mb-3">
                            <label for="baptism_water" class="form-label text-primary">Number of Baptism by
                                Water</label>
                            <input type="number" name="baptism_water" value="0" class="form-control" required>
                        </div>
                        <div class="modal-body mb-3">
                            <label for="baptism_spirit" class="form-label text-primary">Number of Baptism by
                                Spirit</label>
                            <input type="number" name="baptism_spirit" value="0" class="form-control"
                                required>
                        </div>
                        <div class="modal-body mb-3">
                        ...
                        <div class="modal-body mb-3">
                            <label for="branch_id" class="form-label">Branch: <span
                                    class="text-primary">{{ $currentBranch->name }}</span> </label>
                            <input type="number" name="branch_id" value="{{ session('branch_id') }}" hidden
                                readonly>
                        </div>
                        <div class="modal-body   mb-3">
                            <label for="church_id" class="form-label">Church: <span
                                    class="text-primary">{{ $currentChurch->name }}</span> </label>
                            <input type="number" name="church_id" value="{{ session('church_id') }}"
        ...
        <div class="modal fade" id="financeModal" tabindex="-1" aria-labelledby="financeModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('branch_pastor.finances.store') }}" method="POST">
                        @csrf
                        <div class="modal-body mb-3">
                            ...
                            <select name="service_id" class="form-select chosen" required>
                                ...
                                @foreach (App\Models\Service::where('church_id', session('church_id'))->where('branch_id', session('branch_id'))->get() as $service)
                        ...
                        <div class="modal-body mb-3">
                            ...
                            <input type="number" name="worship_offering" value="0" class="form-control"
                                required>
                        </div>
                        <div class="modal-body mb-3">
                            <label for="tithe_offering" class="form-label text-primary">Tithe Offering</label>
                            <input type="number" name="tithe_offering" value="0" class="form-control"
                                required>
                        </div>
                        <div class="modal-body  mb-3">
                            <label for="thanksgiving_offering" class="form-label text-primary">Thanksgiving
                                Offering</label>
                            <input type="number" name="thanksgiving_offering" value="0" class="form-control"
                                required>
                        </div>
                        <div class="modal-body mb-3">
                            <label for="project_offering" class="form-label text-primary">Project Offering</label>
                            <input type="number" name="project_offering" value="0" class="form-control"
                                required>
                        </div>
                        <div class="modal-body mb-3">
                            <label for="special_offering" class="form-label text-primary">Special Offering</label>
                            <input type="number" name="special_offering" value="0" class="form-control"
                                required>
                        </div>
                        <div class="modal-body mb-3">
                            <label for="firstfruits_offering" class="form-label text-primary">Firstfruits
                                Offering</label>
                            <input type="number" name="firstfruits_offering" value="0" class="form-control"
                                required>
                        </div>
                        <div class="modal-body mb-3">
                            <label for="children_offering" class="form-label text-primary">Children Offering</label>
                            <input type="number" name="children_offering" value="0" class="form-control"
                                required>
                        </div>
                        <div class="modal-body mb-3">
                        ...
                        <div class="modal-body mb-3">
                            ...
                            <input type="number" name="books_and_stickers" value="0" class="form-control"
                                required>
                        </div>
                        <div class="modal-body mb-3">
                            <label for="branch_id" class="form-label">Branch: <span
                                    class="text-primary">{{ $currentBranch->name }}</span> </label>
                            <input type="number" name="branch_id" value="{{ $currentBranch->id }}"
                                class="form-control" readonly hidden>
                        </div>
                        <div class="modal-body   mb-3">
                            <label for="church_id" class="form-label">Church: <span
                                    class="text-primary">{{ $currentChurch->name }}</span> </label>
                            <input type="number" name="church_id" value="{{ $currentChurch->id }}"
                                class="form-control" readonly hidden>
                        </div>
                        <div class="modal-body mb-3">
                            <label for="user_id" class="form-label">Admin: {{ Auth::user()->name }}
