...
@section('content')
    <div class="container">
        <div class="mt-4 d-flex justify-content-between">
            ...
            <a href="{{ route('church_admin.finances.create') }}" class="btn btn-primary mb-3">Add New Finance Report</a>
        </div>
            ...
            <tbody>
                @foreach ($finances as $finance)
                    ...
                    <td>{{ $finance->special_offering }}</td> --}}
                        ...
                        <td>
                            <a href="{{ route('church_admin.finances.edit', $finance->id) }}"
                                class="btn btn-warning btn-sm">Edit</a>
                            <a href="{{ route('church_admin.finances.show', $finance->id) }}"
                                class="btn btn-success btn-sm">show</a>
                            <form action="{{ route('church_admin.finances.destroy', $finance->id) }}" method="POST"
