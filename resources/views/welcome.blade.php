...
<head>
    ...
    <title>CMS-Church Management System</title>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/cms_logo.svg" />
...
<body class="antialiased#" id="page-top">
    ...
    <header class="masthead">
        <div class="container">
            ...
            <div class="masthead-heading text-uppercase">{{__('welcome.welcome_note')}} </div>
