    ...
    <div class="container mt-4">
        <div class="card shadow">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('branches.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> New Branch</a>
            </div>
                        ...
                        @foreach ($branches as $branch)
                            <tr>
                                ...
                                <td class="flex justify-between">
                                    <a href="{{ route('branches.edit', $branch) }}" class="btn btn-sm  btn-success"><i class="fas fa-eye"></i> view</a>
