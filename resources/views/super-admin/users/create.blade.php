        ...
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name"
                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:outline-none focus:ring focus:ring-indigo-200"
                    required>
            </div>
            ...
            <div class="mt-6 d-flex justify-content-between align-items-center">
                <button type="submit"
                    class="bg-indigo-600 text-white font-semibold py-2 px-4 rounded shadow hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
